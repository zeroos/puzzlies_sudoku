 ...
 * @author zeroos
 */
public class RedoButton extends utils.MyButton{
	final int X_MARGIN = 3;
	final int Y_MARGIN = 4;
	private boolean enabled = true;

	public RedoButton(ActionListener l){
		this();
	...
	public void paint(Graphics g){
		...
		g.fillPolygon(	new int[]{X_MARGIN+xOffset, getWidth()-X_MARGIN + xOffset, X_MARGIN+xOffset},
		...
		g.drawPolygon(	new int[]{X_MARGIN+xOffset, getWidth()-X_MARGIN + xOffset, X_MARGIN+xOffset},
				new int[]{Y_MARGIN + yOffset,getHeight()/2  + yOffset, getHeight()-Y_MARGIN+ yOffset},
				3);
